...
public class RecipesProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(@NotNull Consumer<FinishedRecipe> consumer) {
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, Blocks.AR_CONTROLLER.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.REDSTONE, de.srendi.advancedperipherals.common.setup.Items.AR_GOGGLES.get())
                .define('E', Tags.Items.ENDER_PEARLS)
